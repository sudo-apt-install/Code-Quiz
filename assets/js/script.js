...
let questionPool = [
  {
    ...
    answer: "10,000",
    funFact:
      "That's in the same league with the Elite Saiyan warriors fighting  in their prime!",
  },
  {
  ...
  {
    question:
      "By the end of Dragon Ball Z, which character is the only character to have never died?",
  ...
  {
    question:
      "From when he learned it in Dragon Ball, until the end of the Z series...How many times did Goku use the Kamehameha Wave?",
  ...
  },
  {
    ...
    answer: "HIS PRIDE!!!!",
    funFact:
      "Babidi got much more than he bargained for trying to control the Prince of Saiyans!",
  },
];

h1El.textContent = "Dragon Ball (qui)Z";
infoEl.textContent =
  "Try to answer the following Dragon Ball/ Dragon Ball Z related questions within the time limit. Keep in mind that incorrect answers will penalize your time by fifteen seconds, and your score!";
...
h1El.setAttribute(
  "style",
  "display: flex; justify-content: center; margin-bottom: 2%; width:100%; text-align:center; color: black; font-size: 2rem;"
);
startButton.setAttribute(
  "style",
  "display: flex; justify-content: center; align-items: space-between; margin:auto; width:20vw; text-align:center; background-color: #CC5200; border-radius: 25px; color: white; "
);

infoEl.setAttribute(
  "style",
  "display: flex; justify-content: center; margin:auto; padding-bottom: 2%; width:100%; text-align:center; color: black; font-size: 2rem;"
);

restartButton.setAttribute(
  "style",
  "display: flex; align-items: space-between; margin:auto; width:10vw; height: 5vh; text-align:center; background-color: green; border-radius: 25px; color: white; "
);
restartButton.style.justifyContent = "center";
restartButton.style.alignItems = "center";

checkHighScores.setAttribute(
  "style",
  "display: flex; justify-content: flex-start; align-items: space-between; width:10vw; height: 5vh; text-align: center; background-color: purple; border-radius: 25px; color: white; "
);
checkHighScores.style.justifyContent = "center";
checkHighScores.style.alignItems = "center";

clearHighScores.setAttribute(
  "style",
  "display: flex; justify-content: flex-end; align-items: space-between; width:10vw; height: 5vh; text-align: center; background-color: #ED254E; border-radius: 25px; color: white; "
);
...
function renderQuestion() {
  ...
  for (let i = 0; i < currentQuestionObject.options.length; i++) {
    ...
    answerChoiceButton.setAttribute(
      "style",
      "display: flex; align-items: space-between; margin:auto; width:10vw; height: 5vh; text-align:center; background-color: #CC5200; border-radius: 25px; color: white; "
    );
...
function setQuizStyling() {
  primaryQuestion.setAttribute(
    "style",
    "display: flex; justify-content: center; margin-top: 5%; margin-bottom: 5%; width:100%; text-align:center; color: black; font-size: 2rem;"
  );
  timeElement.setAttribute(
    "style",
    "display: flex; justify-content: flex-end; width: 95%; font-size: 2rem; "
  );
...
function showHighScoresPage() {
  ...
  highScores.forEach(function (score) {
    ...
    row.innerHTML =
      "<td>" + score.initials + "</td><td>" + score.score + "</td>";
